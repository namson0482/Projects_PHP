...
<?php } ?>
<form id="paypalstandardform" name="paypalstandardform" action="<?php echo $action; ?>" method="post">
  ...
  <input type="hidden" name="custom" value="<?php echo $custom; ?>" />
	...
	<div class="buttons">
	<div class="right"><a class="button" onclick="document.paypalstandardform.submit();" id="button-shipping"><span><?php echo $button_confirm; ?></span></a></div>
	</div>
