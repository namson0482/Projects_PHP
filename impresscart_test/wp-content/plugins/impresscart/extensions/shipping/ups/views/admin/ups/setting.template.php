...
<table class="form">
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_key]" value="<?php echo $ups_key; ?>" />
              <?php if ($error_key) { ?>
           ...
           <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_username]" value="<?php echo $ups_username; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_password]" value="<?php echo $ups_password; ?>" />
          ...
          <tr>
            ...
            <td><select name="impresscart[shipping_method][ups][ups_pickup]">
          ...
          <tr>
            ...
            <td><select name="impresscart[shipping_method][ups][ups_packaging]">
          ...
          <tr>
            ...
            <td><select name="impresscart[shipping_method][ups][ups_classification]">
          ...
          <tr>
            ...
            <td><select name="impresscart[shipping_method][ups][ups_origin]">
          ...
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_city]" value="<?php echo $ups_city; ?>" />
              <?php if ($error_city) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_state]" value="<?php echo $ups_state; ?>" maxlength="2" size="4" />
              <?php if ($error_state) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_country]" value="<?php echo $ups_country; ?>" maxlength="2" size="4" />
          ...
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_postcode]" value="<?php echo $ups_postcode; ?>" /></td>
          </tr>
          ...
          <tr>
            ...
            <td><select name="impresscart[shipping_method][ups][ups_quote_type]">
           ...
           <tr>
            ...
            <td id="service"><div id="US">
              ...
              <a onclick="jQuery(this).parent().find(':checkbox').attr('checked', true);"><?php echo $text_select_all; ?></a> / <a onclick="jQuery(this).parent().find(':checkbox').attr('checked', false);"><?php echo $text_unselect_all; ?></a></td>
          </tr>
          ...
          <tr>
            ...
            <td><?php echo $weight_class_html;?></td>
          </tr>
          <tr>
            <td><?php echo $entry_length_class; ?></td>
            <td><?php echo $length_class_html;?></td>
          </tr>
          
          <tr>
            <td><span class="required">*</span> <?php echo $entry_dimension; ?></td>
            <td><input type="text" name="impresscart[shipping_method][ups][ups_length]" value="<?php echo $ups_length; ?>" size="4" />
          ...
          <tr>
            ...
            <td><select name="impresscart[shipping_method][ups][enabled]">
                <?php if ($ups_status) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="impresscart[shipping_method][ups][ups_sort_order]" value="<?php echo $ups_sort_order; ?>" size="1" /></td>
          </tr>
		  <tr>
            <td><?php echo $entry_debug; ?></td>
            <td><select name="impresscart[shipping_method][ups][ups_debug]">
              <?php if ($ups_debug) { ?>
              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
              <option value="0"><?php echo $text_disabled; ?></option>
              <?php } else { ?>
