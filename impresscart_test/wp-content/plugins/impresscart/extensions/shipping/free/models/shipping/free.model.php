...
class impresscart_shipping_free_model extends impresscart_model {    
  ...
  function update_setting( $data = array()) {
  		...
  		$impresscart_shipping_methods['impresscart']['shipping_method']['free'] = $data['free'];
  ...
  function get_setting()
  {
  		...
  		return @$impresscart_shipping_methods['impresscart']['shipping_method']['free'];
  }
