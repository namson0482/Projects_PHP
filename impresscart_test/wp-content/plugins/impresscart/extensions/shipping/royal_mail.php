...
class royal_mail extends extension {	function __construct(){
	
		parent::__construct();
		$this->type = 'shipping';
		$this->class = 'royal_mail';
		$this->status = 0;
		$this->order = 1;
		$this->prefix = 'impresscart_shipping_royal_mail_';
		
		$this->metaboxes = array(
			
			'setting' => array(
				'id' => 'royal_mail-settings-meta-box',
				'title' => __('Settings'),
				'page' => 'post',
				'context' => 'normal',
				'priority' => 'high',
