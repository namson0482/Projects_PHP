      ...
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="order" value="<?php echo $coupon_order; ?>" size="1" /></td>
          </tr>
        </table>
      </form>
    </div>
    
    <div class="buttons"><a onclick="jQuery('#form').submit();" class="button"><?php echo $button_save; ?></a></div>