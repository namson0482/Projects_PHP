  ...
  <form action="#" method="post" enctype="multipart/form-data" id="return">
      ...
      <div id="return-product-row<?php echo $return_product_row; ?>">
        <div class="content">
          ...
          <div class="return-detail">
            ...
            <div class="return-remove"><a onclick="jQuery('#return-product-row<?php echo $return_product_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></div>
          </div>
        </div>
      </div>
    ...
    <div class="buttons">
      ...
      <div class="right"><a onclick="jQuery('#return').submit();" class="button"><span><?php echo $button_continue; ?></span></a></div>
    </div>
    <input type="hidden" name="pagename" value="shop" />
    <input type="hidden" name="route" value="account/return/insert" />
  </form>  
...
function addReturnProduct() {
	...
	html += '    </div>';
    html += '    <div class="return-remove"><a onclick="jQuery(\'#return-product-row' + return_product_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></div>';
	html += '  </div>';
	html += '</div>';
	
	jQuery('#return-product').append(html);
 
	jQuery('#return-product-row' + return_product_row + ' .date').datepicker({dateFormat: 'yy-mm-dd'});
