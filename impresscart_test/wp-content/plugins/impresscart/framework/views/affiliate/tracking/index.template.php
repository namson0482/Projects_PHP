<div id="content">
  ...
  <p><?php echo $text_generator; ?><br />
  	 <?php echo $text_generator_description; ?><br />	
...
jQuery('input[name=\'product\']').autocomplete({
	...
	source: function(request, response) {
		jQuery.ajax({
			...
			data: {
				action: 'framework',
				fwurl: '/affiliate/tracking/autocomplete', 
	...
	select: function(event, ui) {
		jQuery('input[name=\'product\']').attr('value', ui.item.label);
		jQuery('textarea[name=\'link\']').attr('value', ui.item.value);
		return false;
	}
