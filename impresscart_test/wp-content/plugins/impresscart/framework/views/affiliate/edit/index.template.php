  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $entry_country; ?>
          
          <?php
			    //	echo $country_id.'asdaaaaaaaaaaaa';
			    ?>
          </td>
          <td>
...
jQuery('input[name=\'payment\']').bind('change', function() {
	jQuery('.payment').hide();
	
	jQuery('#payment-' + this.value).show();
});

jQuery('input[name=\'payment\']:checked').trigger('change');
</script> 
