...
class impresscart_attribute_class_date_general extends impresscart_attribute_class_abstract{
	...
	public function displayPostMetaInMetaBox($postmeta, $attribute) {
		?>
			<input size="20" type="text" class="date_attribute" name="productgeneralattributes[<?php echo $attribute->ID?>][value]" value="<?php echo @$postmeta[$attribute->ID]['value']?>" />
		<?php
	}
