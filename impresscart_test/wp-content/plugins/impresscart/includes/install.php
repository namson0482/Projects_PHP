...
function impresscart_install_tables() {
    ...
    /**
	 * create impresscart_options table
	 * This table build the base of product options
	 */
    $sql = "CREATE TABLE {$wpdb->prefix}impresscart_product_options (
    ...
    dbDelta($sql);
     ...
     /**
	 * create impresscart_attributes table
	 * This table build the base of product options
	 */
    $sql = "CREATE TABLE {$wpdb->prefix}impresscart_product_attributes (
		ID		int(11) NOT NULL AUTO_INCREMENT,
	...
	$sql = "CREATE TABLE `{$wpdb->prefix}impresscart_download` (
	...
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_country` (
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
(239, 'Zimbabwe', 'ZW', 'ZWE', '', 0, 1);";;
	...
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_geo_zone` (
  ...
  PRIMARY KEY (`geo_zone_id`)
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
(3, 'UK VAT Zone', 'UK VAT', '2010-02-26 22:33:24', '2009-01-06 23:26:25'),
(4, 'UK Shipping', 'UK Shipping Zones', '2010-12-15 15:18:13', '2009-06-23 01:14:53');";;
	dbDelta($sql); 
		
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_zone` (
  ...
  PRIMARY KEY (`zone_id`)
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_zone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
(201, 14, 'NOS', 'Niederosterreich', 1),
(202, 14, 'OOS', 'Oberosterreich', 1),
...
(677, 43, 'LI', 'Libertador General Bernardo', 1),
...
(887, 55, 'N', 'Nicosia', 1),
(888, 55, 'P', 'Paphos', 1),
(889, 56, 'U', 'ÃƒÅ¡steckÃƒÂ½', 1),
(890, 56, 'C', 'JihoÃ„ï¿½eskÃƒÂ½', 1),
(891, 56, 'B', 'JihomoravskÃƒÂ½', 1),
(892, 56, 'K', 'KarlovarskÃƒÂ½', 1),
(893, 56, 'H', 'KrÃƒÂ¡lovehradeckÃƒÂ½', 1),
(894, 56, 'L', 'LibereckÃƒÂ½', 1),
(895, 56, 'T', 'MoravskoslezskÃƒÂ½', 1),
(896, 56, 'M', 'OlomouckÃƒÂ½', 1),
(897, 56, 'E', 'PardubickÃƒÂ½', 1),
(898, 56, 'P', 'PlzeÃ…Ë†skÃƒÂ½', 1),
(899, 56, 'A', 'Praha', 1),
(900, 56, 'S', 'StÃ…â„¢edoÃ„ï¿½eskÃƒÂ½', 1),
(901, 56, 'J', 'VysoÃ„ï¿½ina', 1),
(902, 56, 'Z', 'ZlÃƒÂ­nskÃƒÂ½', 1),
(903, 57, 'AR', 'Arhus', 1),
...
(1172, 74, '58', 'Nigravvre', 1),
(1173, 74, '59', 'Nord', 1),
(1174, 74, '60', 'Oise', 1),
(1175, 74, '61', 'Orne', 1),
(1176, 74, '62', 'Pas de Calais', 1),
(1177, 74, '63', 'Puy de Dme', 1),
(1178, 74, '64', 'Pyracutnacutes Atlantiques', 1),
(1179, 74, '65', 'Hautes Pyracutnacutes', 1),
(1180, 74, '66', 'Pyracutnacutes Orientales', 1),
(1181, 74, '67', 'Bas Rhin', 1),
(1182, 74, '68', 'Haut Rhin', 1),
(1183, 74, '69', 'Rhne', 1),
(1184, 74, '70', 'Haute Sane', 1),
(1185, 74, '71', 'Sane et Loire', 1),
(1186, 74, '72', 'Sarthe', 1),
(1187, 74, '73', 'Savoie', 1),
...
(1193, 74, '79', 'Deux Sgravvres', 1),
(1194, 74, '80', 'Somme', 1),
(1195, 74, '81', 'Tarn', 1),
(1196, 74, '82', 'Tarn et Garonne', 1),
(1197, 74, '83', 'Var', 1),
(1198, 74, '84', 'Vaucluse', 1),
(1199, 74, '85', 'Vendacute', 1),
(1200, 74, '86', 'Vienne', 1),
...
(1254, 81, 'BAW', 'Baden-Wumrttemberg', 1),
...
(1768, 112, 'PYB', 'pyongan-bukto', 1),
(1769, 112, 'PYN', 'pyongan-namdo', 1),
(1770, 112, 'YAN', 'Ryanggang-do (Yanggang-do)', 1),
(1771, 112, 'NAJ', 'Rason Directly Governed City', 1),
(1772, 112, 'PYO', 'pyongyang Special City', 1),
...
(2191, 140, 'SN', 'StÃ¢â‚¬Å¡nga Nistrului', 1),
...
(2649, 171, 'AC', 'A&ccediores', 1),
(2650, 171, 'AV', 'Aveiro', 1),
(2651, 171, 'BE', 'Beja', 1),
(2652, 171, 'BR', 'Braga', 1),
(2653, 171, 'BA', 'Bragan&ccedia', 1),
(2654, 171, 'CB', 'Castelo Branco', 1),
(2655, 171, 'CO', 'Coimbra', 1),
(2656, 171, 'EV', '&Eacutvora', 1),
(2657, 171, 'FA', 'Faro', 1),
...
(2663, 171, 'PR', 'Porto', 1),
(2664, 171, 'SA', 'Santaracutm', 1),
(2665, 171, 'SE', 'Setacutbal', 1),
...
(2925, 189, 'BA', 'BanskobystrickÃƒÂ½', 1),
(2926, 189, 'BR', 'BratislavskÃƒÂ½', 1),
(2927, 189, 'KO', 'KoÃ…Â¡ickÃƒÂ½', 1),
(2928, 189, 'NI', 'Nitriansky', 1),
(2929, 189, 'PR', 'PreÃ…Â¡ovskÃƒÂ½', 1),
(2930, 189, 'TC', 'TrenÃ„ï¿½iansky', 1),
(2931, 189, 'TV', 'TrnavskÃƒÂ½', 1),
(2932, 189, 'ZI', 'Ã…Â½ilinskÃƒÂ½', 1),
...
(3076, 203, 'X', 'aumvleborg', 1),
(3077, 203, 'I', 'Gotland', 1),
(3078, 203, 'N', 'Halland', 1),
(3079, 203, 'Z', 'Jaummtland', 1),
(3080, 203, 'F', 'Joumnkoumping', 1),
(3081, 203, 'H', 'Kalmar', 1),
(3082, 203, 'G', 'Kronoberg', 1),
(3083, 203, 'BD', 'Norrbotten', 1),
(3084, 203, 'T', 'Oumrebro', 1),
(3085, 203, 'E', 'Oumstergoumtland', 1),
(3086, 203, 'M', 'Skaringne', 1),
(3087, 203, 'D', 'Soumdermanland', 1),
(3088, 203, 'AB', 'Stockholm', 1),
(3089, 203, 'C', 'Uppsala', 1),
(3090, 203, 'S', 'Vaumrmland', 1),
(3091, 203, 'AC', 'Vaumsterbotten', 1),
(3092, 203, 'Y', 'Vaumsternorrland', 1),
(3093, 203, 'U', 'Vaumstmanland', 1),
(3094, 203, 'O', 'Vaumstra oumtaland', 1),
...
(3102, 204, 'GE', 'Gengravve', 1),
(3103, 204, 'GL', 'Glarus', 1),
(3104, 204, 'GR', 'Graubumnden', 1),
(3105, 204, 'JU', 'Jura', 1),
(3106, 204, 'LU', 'Luzern', 1),
(3107, 204, 'NE', 'Neuchacirctel', 1),
...
(3145, 206, 'PH', 'peng-hu', 1),
(3146, 206, 'PT', 'ping-tung', 1),
(3147, 206, 'TG', 'Tai-chung', 1),
(3148, 206, 'TA', 'Tai-nan', 1),
(3149, 206, 'TP', 'Tai-pei county', 1),
(3150, 206, 'TT', 'Tai-tung', 1),
(3151, 206, 'TY', 'Tao-yuan', 1),
(3152, 206, 'YL', 'Yun-lin', 1),
(3153, 206, 'CC', 'Chia-i city', 1),
(3154, 206, 'CL', 'Chi-lung', 1),
(3155, 206, 'HC', 'Hsin-chu', 1),
(3156, 206, 'TH', 'Tai-chung', 1),
(3157, 206, 'TN', 'Tai-nan', 1),
(3158, 206, 'KC', 'Kao-hsiung city', 1),
(3159, 206, 'TC', 'Tai-pei city', 1),
...
(3316, 215, 'ADI', 'AdÃ„Â±yaman', 1),
(3317, 215, 'AFY', 'Afyonkarahisar', 1),
(3318, 215, 'AGR', 'AÃ„Å¸rÃ„Â±', 1),
...
(3325, 215, 'AYI', 'AydÃ„Â±n', 1),
(3326, 215, 'BAL', 'BalÃ„Â±kesir', 1),
(3327, 215, 'BAR', 'BartÃ„Â±n', 1),
(3328, 215, 'BAT', 'Batman', 1),
(3329, 215, 'BAY', 'Bayburt', 1),
(3330, 215, 'BIL', 'Bilecik', 1),
(3331, 215, 'BIN', 'BingÃƒÂ¶l', 1),
(3332, 215, 'BIT', 'Bitlis', 1),
(3333, 215, 'BOL', 'Bolu', 1),
(3334, 215, 'BRD', 'Burdur', 1),
(3335, 215, 'BRS', 'Bursa', 1),
(3336, 215, 'CKL', 'Ãƒâ€¡anakkale', 1),
(3337, 215, 'CKR', 'Ãƒâ€¡ankÃ„Â±rÃ„Â±', 1),
(3338, 215, 'COR', 'Ãƒâ€¡orum', 1),
(3339, 215, 'DEN', 'Denizli', 1),
(3340, 215, 'DIY', 'Diyarbakir', 1),
(3341, 215, 'DUZ', 'DÃƒÂ¼zce', 1),
(3342, 215, 'EDI', 'Edirne', 1),
(3343, 215, 'ELA', 'Elazig', 1),
(3344, 215, 'EZC', 'Erzincan', 1),
(3345, 215, 'EZR', 'Erzurum', 1),
(3346, 215, 'ESK', 'EskiÃ…Å¸ehir', 1),
(3347, 215, 'GAZ', 'Gaziantep', 1),
(3348, 215, 'GIR', 'Giresun', 1),
(3349, 215, 'GMS', 'GÃƒÂ¼mÃƒÂ¼Ã…Å¸hane', 1),
(3350, 215, 'HKR', 'Hakkari', 1),
(3351, 215, 'HTY', 'Hatay', 1),
(3352, 215, 'IGD', 'IÃ„Å¸dÃ„Â±r', 1),
(3353, 215, 'ISP', 'Isparta', 1),
(3354, 215, 'IST', 'Ã„Â°stanbul', 1),
(3355, 215, 'IZM', 'Ã„Â°zmir', 1),
(3356, 215, 'KAH', 'KahramanmaraÃ…Å¸', 1),
(3357, 215, 'KRB', 'KarabÃƒÂ¼k', 1),
...
(3965, 190, '10', 'Notranjsko-kraÃ…Â¡ka', 1),
(3966, 190, '11', 'GoriÃ…Â¡ka', 1),
(3967, 190, '12', 'Obalno-kraÃ…Â¡ka', 1),
(3968, 33, '', 'Ruse', 1);";

dbDelta($sql);
	
$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_zone_to_geo_zone` (
  ...
  PRIMARY KEY (`zone_to_geo_zone_id`)
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
(57, 222, 0, 3, '2010-02-26 22:33:24', '0000-00-00 00:00:00'),
(65, 222, 0, 4, '2010-12-15 15:18:13', '0000-00-00 00:00:00');";
	dbDelta($sql); 
	
	
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_tax_class` (
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
	(9, 'Taxable Goods', 'Taxed Stuff', '2009-01-06 23:21:53', '2011-09-23 14:07:50'),
	(10, 'Downloadable Products', 'Downloadable', '2011-09-21 22:19:39', '2011-09-22 10:27:36');";
		dbDelta($sql);
	
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_tax_rate` (
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
		(86, 3, 'VAT (17.5%)', 17.5000, 'P', '2011-03-09 21:17:10', '2011-09-22 22:24:29'),
		(87, 3, 'Eco Tax (-2.00)', 2.0000, 'F', '2011-09-21 21:49:23', '2011-09-23 00:40:19');";
	dbDelta($sql);
	
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_tax_rule` (
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
		(121, 10, 86, 'payment', 1),
		(120, 10, 87, 'store', 0),
		(128, 9, 86, 'shipping', 1),
		(127, 9, 87, 'shipping', 2);";
	...
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_currency` (
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
	(1, 'Pound Sterling', 'GBP', 'Ã‚Â£', '', '2', 0.63510001, 1, '2012-07-28 10:16:33'),
	(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2012-07-28 10:16:33'),
	(3, 'Euro', 'EUR', '', 'Ã¢â€šÂ¬', '2', 0.81140000, 1, '2012-07-28 10:16:33');";
	dbDelta($sql);
	
	$sql = "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}impresscart_unit` (
	...
	$sql = "INSERT INTO `{$wpdb->prefix}impresscart_unit` (`unit_id`, `title`,`unit`,`value`, `type`) VALUES
		('1', 'Centimeter', 'cm', 1.00000000, 'length'),
		('2', 'Millimeter', 'mm', 10.00000000, 'length'),
		('3', 'Inch', 'in', 0.39370000, 'length'),
		('4', 'Kilogram', 'kg', 1.00000000, 'weight'),
		('5', 'Gram', 'g', 1000.00000000, 'weight'),
		('6', 'Pound ', 'lb', 2.20460000,'weight'),
		('7', 'Ounce', 'oz',35.27400000,'weight');";
	dbDelta($sql);	
	# end 
...
function impresscart_register_roles() {
	$role = get_role('subscriber');
	add_role('basic', __('Basic'), $role->capabilities );
	add_role('bronze', __('Bronze'), $role->capabilities );
	add_role('silver', __('Silver'), $role->capabilities );
	add_role('gold', __('Gold'), $role->capabilities );
...
function impresscart_install_pages()
{
	$impresscart = array(
		...
		'post_parent' => 0,
		'menu_order' => 0,
		'post_content' => 'Impresscart Homepage',
	...
	$shoppingcart = array(
		...
		'post_type' => 'page',		
		'post_parent' => $parent_page,
		'post_content' => '[impresscart action="/checkout/cart"]',
